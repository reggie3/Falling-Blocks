     ...
     private getAdjacentcandies(arrays) {
         ...
         if (arrays.left.length === 2) {
          ...
          if (arrays.right.length === 2) {
             adjacentCandies.right.push(
                 this,
                 Candy.getCandyByID(arrays.right[0].object.userData.candyID), Candy.getCandyByID(arrays.right[1].object.candyID)
             );
         }
         if (arrays.up.length === 2) {
             adjacentCandies.up.push(
                 Candy.getCandyByID(arrays.up[1].object.userData.candyID), Candy.getCandyByID(arrays.up[0].object.candyID),
                 this
             );
         }
         if (arrays.down.length === 2) {
             adjacentCandies.down.push(
                 this,
                 Candy.getCandyByID(arrays.down[0].object.userData.candyID), Candy.getCandyByID(arrays.down[1].object.candyID)
             );
         }
